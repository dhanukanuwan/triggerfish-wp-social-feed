<?php
 ...
 class WpSocialTwitter {
    ...
    /**
     * Initialize a new WpSocialTwitter object
     */
    ...
    private function fetch_tweets () {
      ...
      require_once( plugin_dir_path( __FILE__ ) . 'wp-social-twitter-auth.php' );
    ...
    public function autolink ($tweet) {
      require_once( plugin_dir_path( __FILE__ ) . 'twitter-text-php/Autolink.php');
